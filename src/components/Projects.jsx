        ...
        <div
          onClick={() => {
            ...
            setWebFilteredProjects(
              allProjects.filter(
                (project) =>
                  project.type === "Static" && project.device === "web",
              ),
            );
          }}
        >
        ...
        <div
          onClick={() => {
            ...
            setWebFilteredProjects(
              allProjects.filter(
                (project) =>
                  project.type === "Full Stack" && project.device === "web",
              ),
            );
          }}
        >
        ...
        <div
          onClick={() => {
            ...
            setWebFilteredProjects(
              allProjects.filter(
                (project) =>
                  project.type === "External API" && project.device === "web",
              ),
            );
          }}
        >
  ...
  return (
    <>
      <div ref={projects} className="mt-28 md:mt-48 font-notosans">
        <div className="flex justify-center border-2 mx-6 md:mx-72 rounded-full">
          <div
            ...
            className={`cursor-pointer text-xl py-2 md:text-2xl w-1/2 flex justify-center font-semibold text-[#eef065] ${projectsType === "all" && "border-2 border-yellow-300 bg-yellow-300 rounded-full text-white"}`}
          >
            All
          </div>
          <div
            onClick={() => setProjectsType("web")}
            className={`cursor-pointer text-xl py-2 md:text-2xl w-1/2 flex justify-center font-semibold text-[#eef065] ${projectsType === "web" && "border-2 border-yellow-300 bg-yellow-300 rounded-full text-white"}`}
          >
            Web
          </div>
          <div
            ...
            className={`cursor-pointer text-xl py-2 md:text-2xl w-1/2 flex justify-center font-semibold text-[#eef065] ${projectsType === "mobile" && "border-2 border-yellow-300 bg-yellow-300 rounded-full text-white"}`}
          >
            Mobile
          </div>
        </div>
      ...
      <div
        ...
        className={`grid grid-cols-1 md:grid-cols-3 gap-x-10 gap-y-10 mt-20 px-12 md:px-36 font-notosans ${projectsType === "web" && (webFilteredProjects.length !== 0 || webProjectType !== "Filter") ? "hidden" : "block"}`}
      >
        {allProjects.map((project) => (
          <div key={project.title}>
            ...
            {projectsType === "web" && project.device === "web" && (
              <ProjectsCard key={project.title} project={project} />
            )}
            {projectsType === "mobile" && project.device === "mobile" && (
              <ProjectsCard key={project.title} project={project} />
            )}
          </div>
        ))}
      ...
      <div
        className={`grid grid-cols-1 md:grid-cols-3 gap-x-10 gap-y-10 mt-20 px-12 md:px-36 font-notosans ${projectsType === "web" && webFilteredProjects.length === 0 ? "hidden" : "block"}`}
      >
